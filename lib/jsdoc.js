...
let injector;
import("../../../scripts/type_injector/injector.js").then(mod => {
...
function parseJSDocType(typeValue) {
    ...
    if (typeValue.indexOf('|') > -1 && typeValue.indexOf('Extract<') !== 0 && typeValue.indexOf('Exclude<') !== 0) {
    ...
    if (typeValue.startsWith('import(')) {
        ...
        if (match) {
            ...
            return injector ? injector(def) : def;
        }
    }
